...
export async function triggerReconcileWorkflow(
  jobId: string,
  vendorKey: string,
  qbFileCount: number,
  stmtFileCount: number,
  stmtFileExtensions: string[],
): Promise<void> {
    ...
    `https://api.github.com/repos/${owner}/${repo}/dispatches`,
    {
      ...
      body: JSON.stringify({
        ...
        client_payload: {
          ...
          qb_file_count: qbFileCount,
          stmt_file_count: stmtFileCount,
          stmt_file_extensions: stmtFileExtensions.join(','),
        },
      }),
    }
  );
